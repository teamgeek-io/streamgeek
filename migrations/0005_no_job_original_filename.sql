...
INSERT INTO "new_Job" ("agentId", "createdAt", "errorMessage", "id", "outputUrl", "status", "updatedAt", "videoId") SELECT "agentId", "createdAt", "errorMessage", "id", "outputUrl", "status", "updatedAt", "videoId" FROM "Job";
DROP TABLE "Job";
